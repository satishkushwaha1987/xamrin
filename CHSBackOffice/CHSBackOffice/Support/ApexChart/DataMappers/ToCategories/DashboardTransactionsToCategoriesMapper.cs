...
{
    public class DashboardTransactionsToCategoriesMapper : IDataToCategoriesMapper
    {
        ...
        public DashboardTransactionsToCategoriesMapper(DashboardTransactions transactions, string state, DateTime utcNow)
        {
