...
namespace CHSBackOffice.iOS.Rendereres
{
    ...
    public class RadioButtonView : UIButton
    {
        ...
        void ApplyStyle()
        {
            SetImage(UIImage.FromBundle("Images/RadioButton/checked_radiobutton.png"), UIControlState.Selected);
            SetImage(UIImage.FromBundle("Images/RadioButton/unchecked_radiobutton.png"), UIControlState.Normal);
        }
    }
}